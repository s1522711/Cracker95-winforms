...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        KeyTypeGroup.Location = New Point(216, 71)
        ...
        ' GenButton
        ' 
        GenButton.Location = New Point(216, 13)
        ...
        ' ValidatorBtn
        ' 
        ValidatorBtn.Location = New Point(216, 223)
        ...
        ValidatorOutput.Location = New Point(12, 249)
        ...
        ' CopyBtn
        ' 
        CopyBtn.Location = New Point(216, 42)
